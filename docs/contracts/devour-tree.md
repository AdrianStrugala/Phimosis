...
Preferowane `tensura:spell_icon_<spell>`. Obecnie takich ikon sa 93 na 107 spelli —
reszta uzywa itemow waniliowych i to jest w porzadku jako stan przejsciowy.
