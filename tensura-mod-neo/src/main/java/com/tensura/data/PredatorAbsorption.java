...
/**
 * The single place that performs a devour absorption: record it, mirror it onto
 * the puffish_skills tree, and tell the player.
 *
...
public final class PredatorAbsorption {
    ...
    * normal "<spell>" dispenser drawn on top of it, which opens focus assignment and
    * immediately re-locks so it can be clicked again.
     */
