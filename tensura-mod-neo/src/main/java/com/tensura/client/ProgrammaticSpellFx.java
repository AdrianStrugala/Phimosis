...
public final class ProgrammaticSpellFx {
    ...
    private static BeamEmitter beam(int duration, Palette palette, float width) {
        ...
        return switch (style) {
            ...
            case "thundershock_snap" -> new CastProfile(CastFamily.BURST, 8);
            ...
            case "will_o_wisp_conjure" -> new CastProfile(CastFamily.STANCE, 5);
            ...
            case "thunderbolt_arc_cast" -> new CastProfile(CastFamily.FOCUS, 8);
            case "fire_blast_star_cast" -> new CastProfile(CastFamily.BURST, 9);
            case "scald_pressure_cast" -> new CastProfile(CastFamily.CHANNEL, 11);
            case "bubble_beam_stream" -> new CastProfile(CastFamily.VOLLEY, 12);
            case "energy_ball_gather" -> new CastProfile(CastFamily.FOCUS, 9);
            ...
            case "sacred_fire_invocation" -> new CastProfile(CastFamily.CHANNEL, 13);
            case "dragon_pulse_coil" -> new CastProfile(CastFamily.FOCUS, 10);
            case "iron_strike_charge" -> new CastProfile(CastFamily.DASH, 8);
