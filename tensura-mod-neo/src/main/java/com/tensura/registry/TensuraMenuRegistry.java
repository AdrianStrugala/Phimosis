...
import com.tensura.gui.SkillSelectMenu;
...
public class TensuraMenuRegistry {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<SkillSelectMenu>> SKILL_SELECT =
            MENUS.register("skill_select", () -> IMenuTypeExtension.create(SkillSelectMenu::new));
