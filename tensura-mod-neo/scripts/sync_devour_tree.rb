...
RAYS = {
  ...
  psychic: %w[confusion psybeam psycho_cut psychic rest trick_room future_sight],
...
DESCRIPTION_OVERRIDES = {
  ...
  "psychic" => "Instantly strike one aimed enemy with Psychic force, knocking it back and sometimes weakening it.",
  ...
  "dig" => "Burrow for up to two seconds with a visible ground trail, then erupt on contact, collision, or recast.",
