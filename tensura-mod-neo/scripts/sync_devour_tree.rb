...
DESCRIPTION_OVERRIDES = {
  ...
  "toxic_spikes" => "Place six poisonous traps in a ring. Crossing the ring poisons, while repeated crossings escalate the effect to Toxic.",
  "u_turn" => "Dash through an enemy with Bug energy, then return to where you started.",
  "future_sight" => "Mark an enemy for three seconds, then deal a Psychic hit plus a capped echo of damage taken during the mark.",
  ...
  "protect" => "Raise a transparent wall for ten seconds that intercepts attacks crossing toward you or nearby allies.",
  "aurora_veil" => "Raise an icy aurora with three visible segments. Each segment breaks after absorbing enough damage for nearby allies.",
  "tailwind" => "Create a slipstream behind you that speeds allies moving with the wind and slows enemies pushing against it.",
  ...
  "solar_beam" => "Charge a devastating Nature beam; open daylight shortens the charge without removing its telegraph.",
  "petal_blizzard" => "Orbit yourself with cutting petals for four seconds, then recast to release them in a radial blast.",
  "blizzard" => "Drive a moving snowstorm that builds Chill and shatters Frozen enemies on its final pulse.",
  ...
  "moonblast" => "Launch a lunar blast whose explosion pulls nearby enemies toward its center and weakens special damage.",
  "dazzling_gleam" => "Charge briefly, then release one prismatic nova that damages and pushes enemies in every direction.",
  ...
  "crunch" => "Mark an area with abyssal jaws that close after a short warning, damage enemies, and sometimes leave them Exposed.",
  ...
  "overheat" => "Release three widening waves of flame with rising knockback, then become Exhausted.",
  "volt_tackle" => "Surge with speed and electricity for ten seconds, damaging each enemy once on contact.",
  "psychic" => "Instantly damage one aimed enemy with concentrated Psychic force.",
  ...
  "outrage" => "Enter three Dragon charges with increasingly wide impacts, then become briefly Confused.",
  "foul_play" => "Make an enemy's own attack strength determine how hard the shadow strike hits.",
  "flash_cannon" => "Fire a piercing Steel beam that splits into two half-power rays after striking an armored enemy.",
  "dragon_rush" => "Steer a Dragon-powered charge whose central impact staggers enemies.",
  "phantom_force" => "Phase out for up to one and a half seconds, then reappear with a telegraphed directional strike.",
  "rock_tomb" => "Mark a quarry where four rocks close inward, then crush and slow enemies still inside.",
  "stealth_rock" => "Orbit yourself with six rock shards; each shard strikes one enemy that enters contact range.",
  "trick_room" => "Create an inverted room where fast creatures slow down and slow creatures speed up.",
  "dig" => "Burrow beneath the ground, then emerge behind the aimed enemy after a short delay.",
  "rock_slide" => "Drop five rocks across a broad area, slowing enemies and knocking them away.",
  "stone_edge" => "Drive a narrow line of stone spires through enemies, ignoring four points of armor.",
  "shadow_ball" => "Launch a slow shadow orb that briefly pulls nearby enemies inward before its impact burst.",
  "dark_pulse" => "Send out a Dark ring that interrupts casts, then pull it inward for one damaging return pulse.",
  "focus_blast" => "Hold to charge a Fighting orb from a quick smaller blast to a full-power wide explosion that sometimes leaves enemies Exposed.",
  "x_scissor" => "Cross through an enemy with two opposing Bug cuts; landing both leaves the target Exposed.",
  "bug_buzz" => "Channel resonant Bug waves that damage enemies, strip Guard, interrupt casts, and leave them Exposed.",
  "iron_defense" => "Gain sixteen Guard divided into four visible Steel plates that fracture as damage is absorbed.",
  "draco_meteor" => "Call six Dragon meteors around a marked constellation, followed by one central comet."
}.freeze
